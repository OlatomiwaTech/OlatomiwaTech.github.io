      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 pb-8 border-b border-slate-800/60">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-lg font-bold text-[#F8FAFC]">
              <div className="w-7 h-7 rounded-lg bg-[#111827] border border-slate-800 flex items-center justify-center">
            ...
            <p className="text-xs text-[#94A3B8] max-w-sm">
              Full-stack software engineering, product architecture, and digital solutions.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            >
              ...
              <span>GitHub — github.com/OlatomiwaTech</span>
            </a>
          </div>
          ...
          <div>
            <button
              onClick={scrollToTop}
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-[#111827] border border-slate-800 text-xs font-mono text-[#94A3B8] hover:text-[#38BDF8] hover:border-slate-700 transition-colors"
            >
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#94A3B8] font-mono">
          ...
          <p className="text-slate-500">
            Built with <span className="text-[#F8FAFC]">React</span> + <span className="text-[#F8FAFC]">TypeScript</span> + <span className="text-[#38BDF8]">Tailwind CSS</span>
          </p>
        </div>

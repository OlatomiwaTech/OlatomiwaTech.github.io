      ...
      <div className="relative z-10 section-container">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[var(--section-gap)] items-center">
          ...
          <div className="lg:col-span-5 space-y-[var(--content-gap)] text-left">
            ...
            <h1 className="type-hero font-black text-[#F5F7FA] max-w-[22ch] sm:max-w-none">
            ...
            <p className="text-[#94A0B4] type-lead font-normal prose-width">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
              ...
              <button
                ...
                className="signal-link text-xs font-mono text-[#94A0B4] sm:ml-2 touch-target !min-w-0 px-2"
              >
                About Me →
              </button>
            </div>
            ...
            <div className="pt-4 border-t border-white/[0.08] flex flex-wrap items-center gap-2">
              <span className="font-mono text-[10px] text-[#94A0B4] uppercase tracking-wider mr-1 w-full sm:w-auto">
                STACK:
              </span>
          ...
          <div className="lg:col-span-7 relative min-w-0" style={{ perspective: '1200px' }}>
            ...
            >
              <div className="bg-[#090D18] px-3 sm:px-4 py-3 border-b border-white/[0.08] flex items-center justify-between gap-2 min-w-0">
                ...
                <div className="hidden sm:flex bg-[#080B14] rounded-md px-3 py-1 text-xs font-mono text-[#94A0B4] border border-white/[0.06] items-center gap-2 min-w-0 truncate">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 shrink-0" />
                  <span className="truncate">nuvora.school / admin</span>
                </div>
                <div className="flex items-center gap-1 text-[10px] sm:text-[11px] font-mono text-[#38BDF8] bg-[#38BDF8]/10 px-2 py-0.5 rounded border border-[#38BDF8]/20 shrink-0">
                  <span>REAL WORK</span>
                </div>
              </div>

              <div className="p-4 sm:p-6 space-y-4 sm:space-y-5 bg-[#0E1320]">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/[0.06] pb-4">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-bold text-sm text-[#F5F7FA] tracking-tight truncate">
                        Petra School Platform (Nuvora)
                      </h3>
                      <p className="text-xs font-mono text-[#94A0B4] truncate">
                ...
                <div className="grid grid-cols-1 min-[400px]:grid-cols-3 gap-2 sm:gap-3">
                  {[
                    ...
                    <div key={label} className="bg-[#080B14] p-3 rounded-xl border border-white/[0.06] space-y-1 min-w-0">
              ...
              <div className="mx-4 sm:mx-6 mb-4 sm:mb-6 p-3 sm:p-4 rounded-xl bg-[#131927] border border-[#38BDF8]/30 shadow-xl flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-8 h-8 rounded-lg bg-[#38BDF8]/20 border border-[#38BDF8]/40 flex items-center justify-center text-[#38BDF8] shrink-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-[#94A0B4] line-clamp-2">
        ...
        <div className="mt-[clamp(2rem,5vh,3.5rem)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs text-[#94A0B4]">
          <div className="flex items-center gap-3 min-w-0">
            <span className="w-2 h-2 rounded-full bg-emerald-400 shrink-0" />
          ...
          <button
            ...
            className="flex items-center gap-2 font-mono text-[11px] text-[#94A0B4] hover:text-[#38BDF8] transition-colors group signal-link touch-target !min-w-0 self-start sm:self-auto"
          >

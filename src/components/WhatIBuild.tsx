...
export const WhatIBuild: React.FC = () => {
  return (
    <>
      ...
      <section id="capabilities" className="bg-[#0E1320]/80 section-shell border-t border-white/[0.06] relative">
        <div className="section-container">
          ...
          <div
            className="mb-12 md:mb-16 p-4 sm:p-6 md:p-8 rounded-2xl border border-white/[0.08] bg-[#080B14]/60 backdrop-blur-sm min-w-0"
            ...
            {CAPABILITY_PILLARS.map((pillar, idx) => (
              ...
              >
                ...
                <div className="md:col-span-4 min-w-0">
                  <h3 className="text-lg sm:text-xl md:text-2xl font-extrabold text-[#F5F7FA] group-hover:text-[#38BDF8] transition-colors tracking-tight">
                    {pillar.title}
                  </h3>
